...
pacman -Syy \
    ...
    zed dotnet-sdk dotnet-targeting-pack aspnet-runtime aspnet-targeting-pack mono nasm gtk-sharp-3 gtk-layer-shell rust docker docker-compose docker-dinit arduino-cli gnu-efi \
