...
sudo pacman -Sy hyprland xdg-desktop-portal-hyprland hyprpaper hyprpicker hyprlock hypridle hyprsunset alacritty nemo grim slurp rofi wl-clip-persist quickshell upower
