...
pacman -Syu gdm gnome-shell gnome-shell-extensions gnome-terminal gnome-control-center gnome-tweaks base-devel ttf-liberation xdg-utils libcurl-gnutls libadwaita libxss networkmanager dconf-editor nemo git zsh python3 python-pip brightnessctl pulseaudio ufw unzip wl-clipboard grim slurp mpv x265 x264 gtk4 rclone dosfstools exfatprogs cups cups-pdf sane-airscan mono gtk-sharp-3 gtk-layer-shell nasm qemu-system-x86 arduino-cli obs-studio android-udev android-file-transfer htop evemu
